...
var LiveRegion = function LiveRegion2(props) {
  ...
  var messages = (0, import_react5.useMemo)(function() {
    return _objectSpread2(_objectSpread2({}, defaultAriaLiveMessages), ariaLiveMessages || {});
  }, [ariaLiveMessages]);
  var ariaSelected = (0, import_react5.useMemo)(function() {
    var message = "";
  ...
  var ariaFocused = (0, import_react5.useMemo)(function() {
    var focusMsg = "";
  ...
  var ariaResults = (0, import_react5.useMemo)(function() {
    var resultsMsg = "";
  ...
  var ariaGuidance = (0, import_react5.useMemo)(function() {
    var guidanceMsg = "";
  ...
  var ScreenReaderText = jsx(import_react5.Fragment, null, jsx("span", {
    id: "aria-selection"
  ...
  return jsx(import_react5.Fragment, null, jsx(A11yText$1, {
    id
...
function useScrollCapture(_ref3) {
  ...
  var handleEventDelta = (0, import_react5.useCallback)(function(event, delta) {
  ...
  var onWheel = (0, import_react5.useCallback)(function(event) {
    handleEventDelta(event, event.deltaY);
  }, [handleEventDelta]);
  var onTouchStart = (0, import_react5.useCallback)(function(event) {
    touchStart.current = event.changedTouches[0].clientY;
  }, []);
  var onTouchMove = (0, import_react5.useCallback)(function(event) {
    var deltaY = touchStart.current - event.changedTouches[0].clientY;
    handleEventDelta(event, deltaY);
  }, [handleEventDelta]);
  var startListening = (0, import_react5.useCallback)(function(el) {
    if (!el) return;
  ...
  var stopListening = (0, import_react5.useCallback)(function(el) {
    if (!el) return;
...
function useScrollLock(_ref3) {
  ...
  var scrollTarget = (0, import_react5.useRef)(null);
  var addScrollLock = (0, import_react5.useCallback)(function(touchScrollTarget) {
    if (!canUseDOM) return;
  ...
  var removeScrollLock = (0, import_react5.useCallback)(function(touchScrollTarget) {
    if (!canUseDOM) return;
    var target = document.body;
    var targetStyle = target && target.style;
...
function ScrollManager(_ref3) {
  ...
  return jsx(import_react5.Fragment, null, lockEnabled && jsx("div", {
...
var _excluded4 = ["defaultInputValue", "defaultMenuIsOpen", "defaultValue", "inputValue", "menuIsOpen", "onChange", "onInputChange", "onMenuClose", "onMenuOpen", "value"];
function useStateManager(_ref3) {
  var _ref$defaultInputValu = _ref3.defaultInputValue, defaultInputValue = _ref$defaultInputValu === void 0 ? "" : _ref$defaultInputValu, _ref$defaultMenuIsOpe = _ref3.defaultMenuIsOpen, defaultMenuIsOpen = _ref$defaultMenuIsOpe === void 0 ? false : _ref$defaultMenuIsOpe, _ref$defaultValue = _ref3.defaultValue, defaultValue = _ref$defaultValue === void 0 ? null : _ref$defaultValue, propsInputValue = _ref3.inputValue, propsMenuIsOpen = _ref3.menuIsOpen, propsOnChange = _ref3.onChange, propsOnInputChange = _ref3.onInputChange, propsOnMenuClose = _ref3.onMenuClose, propsOnMenuOpen = _ref3.onMenuOpen, propsValue = _ref3.value, restSelectProps = _objectWithoutProperties(_ref3, _excluded4);
  var _useState = (0, import_react7.useState)(propsInputValue !== void 0 ? propsInputValue : defaultInputValue), _useState2 = _slicedToArray(_useState, 2), stateInputValue = _useState2[0], setStateInputValue = _useState2[1];
  var _useState3 = (0, import_react7.useState)(propsMenuIsOpen !== void 0 ? propsMenuIsOpen : defaultMenuIsOpen), _useState4 = _slicedToArray(_useState3, 2), stateMenuIsOpen = _useState4[0], setStateMenuIsOpen = _useState4[1];
  var _useState5 = (0, import_react7.useState)(propsValue !== void 0 ? propsValue : defaultValue), _useState6 = _slicedToArray(_useState5, 2), stateValue = _useState6[0], setStateValue = _useState6[1];
  var onChange2 = (0, import_react7.useCallback)(function(value2, actionMeta) {
    if (typeof propsOnChange === "function") {
      propsOnChange(value2, actionMeta);
    }
    setStateValue(value2);
  }, [propsOnChange]);
  var onInputChange = (0, import_react7.useCallback)(function(value2, actionMeta) {
    var newValue;
  ...
  var onMenuOpen = (0, import_react7.useCallback)(function() {
    if (typeof propsOnMenuOpen === "function") {
      propsOnMenuOpen();
    }
    setStateMenuIsOpen(true);
  }, [propsOnMenuOpen]);
  var onMenuClose = (0, import_react7.useCallback)(function() {
...
function useCreatable(_ref3) {
  ...
  var newOption = (0, import_react8.useMemo)(function() {
  ...
  var options2 = (0, import_react8.useMemo)(function() {
    return (allowCreateWhileLoading || !isLoading) && newOption ? createOptionPosition === "first" ? [newOption].concat(_toConsumableArray(propsOptions)) : [].concat(_toConsumableArray(propsOptions), [newOption]) : propsOptions;
  }, [allowCreateWhileLoading, createOptionPosition, isLoading, newOption, propsOptions]);
  var onChange2 = (0, import_react8.useCallback)(function(newValue, actionMeta) {
...
var CreatableSelect = (0, import_react9.forwardRef)(function(props, ref) {
