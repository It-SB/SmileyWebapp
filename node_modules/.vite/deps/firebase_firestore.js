...
// node_modules/firebase/node_modules/@firebase/firestore/dist/index.esm2017.js
...
var BloomFilter = class _BloomFilter {
  ...
  Ee(e, t, n) {
    ...
    return 1 === r.compare(Pe) && (r = new Integer([r.getBits(0), r.getBits(1)], 0)), r.modulo(this.Te).toNumber();
  }
    ...
    if (r) {
      ...
      if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
        ...
        if (r2 !== n) {
          ...
          null == he || he.et(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            var s, o, _, a, u, c;
            const l = {
              localCacheCount: e2,
...
var __PRIVATE_OrderedCodeWriter = class {
  ...
  Ot(e) {
    for (const t of e) {
      ...
      if (e2 < 128) this.Ct(e2);
      else if (e2 < 2048) this.Ct(960 | e2 >>> 6), this.Ct(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t) this.Ct(480 | e2 >>> 12), this.Ct(128 | 63 & e2 >>> 6), this.Ct(128 | 63 & e2);
      else {
  ...
  Nt(e) {
    for (const t of e) {
      const e2 = t.charCodeAt(0);
      if (e2 < 128) this.Mt(e2);
      else if (e2 < 2048) this.Mt(960 | e2 >>> 6), this.Mt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t) this.Mt(480 | e2 >>> 12), this.Mt(128 | 63 & e2 >>> 6), this.Mt(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
...
var __PRIVATE_TargetIndexMatcher = class {
  ...
  tn(e) {
    ...
    if (void 0 !== t && !this.nn(t)) return false;
    ...
    if (this.Yt.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.rn(e2, t2) || !this.sn(this.Zt[s++], t2)) return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.Zt.length || !this.sn(this.Zt[s++], e2)) return false;
    }
    return true;
  }
  /**
  ...
  nn(e) {
    for (const t of this.Xt) if (this.rn(t, e)) return true;
    return false;
  }
  rn(e, t) {
...
var __PRIVATE_IndexedDbIndexManager = class {
      ...
      if (r) {
        ...
        return PersistencePromise.forEach(i, (i2, s) => {
          ...
          const o = function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            return new Bound(n2, r3);
          }(s, i2), c = this.hn(i2, s, a), l = this.hn(i2, s, u), h = this.Pn(i2, s, _), P = this.In(i2.indexId, o, c, a.inclusive, l, u.inclusive, h);
  ...
  In(e, t, n, r, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Tn(t[c / a]) : de, l = this.En(e, _2, n[c % a], r), h = this.dn(e, _2, i[c % a], s), P = o.map((t2) => this.En(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  ln(e, t) {
    ...
    return this.getFieldIndexes(e, r).next((e2) => {
      let t2 = null;
      for (const r2 of e2) {
        n.tn(r2) && (!t2 || r2.fields.length > t2.fields.length) && (t2 = r2);
      }
      return t2;
    });
  }
  getIndexType(e, t) {
    let n = 2;
    const r = this.cn(t);
    return PersistencePromise.forEach(r, (t2) => this.ln(e, t2).next((e2) => {
  ...
  Pn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r) if (this.Vn(t, s.fieldPath) && isArray(e2)) r = this.mn(r, s, e2);
      else {
  ...
  mn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || []) for (const n2 of r) {
      ...
      r2.seed(n2.Wt()), __PRIVATE_FirestoreIndexValueWriter.bt.Pt(e2, r2.Ht(t.kind)), i.push(r2);
    }
    return i;
  }
  Vn(e, t) {
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.gn(e).next((e2) => r.U("collectionGroupIndex", IDBKeyRange.bound(t, t)).next((t2) => PersistencePromise.forEach(t2, (t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.uid, e2, n)))));
  }
  updateIndexEntries(e, t) {
    ...
    return PersistencePromise.forEach(t, (t2, r) => {
      ...
      return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t2.collectionGroup)).next((i2) => (n.set(t2.collectionGroup, i2), PersistencePromise.forEach(i2, (n2) => this.pn(e, t2, n2).next((t3) => {
        const i3 = this.yn(r, n2);
        return t3.isEqual(i3) ? PersistencePromise.resolve() : this.wn(e, r, n2, t3, i3);
      }))));
    });
  }
  Sn(e, t, n, r) {
  ...
  yn(e, t) {
    ...
    if (null != i) {
      ...
      if (isArray(s)) for (const i2 of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Tn(i2), r));
  ...
  createRange(e, t, n) {
    ...
    for (let e2 = 0; e2 < r.length; e2 += 2) {
      if (this.Dn(r[e2], r[e2 + 1])) return [];
      const t2 = [r[e2].indexId, this.uid, r[e2].arrayValue, r[e2].directionalValue, de, []], n2 = [r[e2 + 1].indexId, this.uid, r[e2 + 1].arrayValue, r[e2 + 1].directionalValue, de, []];
...
var __PRIVATE_LruScheduler = class {
  ...
  zn(e) {
    __PRIVATE_logDebug("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.Gn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, async () => {
      this.Gn = null;
      try {
...
var __PRIVATE_MemoryDocumentOverlayCache = class {
  ...
  removeOverlaysForBatchId(e, t, n) {
    ...
    return void 0 !== r && (r.forEach((e2) => this.overlays = this.overlays.remove(e2)), this.hr.delete(n)), PersistencePromise.resolve();
  }
  getOverlaysForCollection(e, t, n) {
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    for (const t2 of r) this.wr = this.wr.add(new __PRIVATE_DocReference(t2.key, i)), this.indexManager.addToCollectionParentIndex(e, t2.key.path.popLast());
  ...
  getAllMutationBatchesAffectingQuery(e, t) {
    ...
    return this.wr.forEachWhile((e2) => {
      ...
      // TODO(mcg): we'll need a different scanner when we implement
      // ancestor queries.
      (t2.length === r && (o = o.add(e2.pr)), true);
...
var __PRIVATE_MemoryLruDelegate = class ___PRIVATE_MemoryLruDelegate {
  constructor(e, t) {
    this.persistence = e, this.Zr = new ObjectMap((e2) => __PRIVATE_encodeResourcePath(e2.path), (e2, t2) => e2.isEqual(t2)), this.garbageCollector = __PRIVATE_newLruGarbageCollector(this, t);
  }
  static Hr(e, t) {
  ...
  Jn(e, t) {
    return PersistencePromise.forEach(this.Zr, (n, r) => this.er(e, n, r).next((e2) => e2 ? PersistencePromise.resolve() : t(r)));
  }
  removeTargets(e, t, n) {
  ...
  removeOrphanedDocuments(e, t) {
    ...
    return r.Fr(e, (r2) => this.er(e, r2, t).next((e2) => {
...
var __PRIVATE_SchemaConverter = class {
  ...
  O(e, t, n, r) {
    ...
    })), n < 5 && r >= 5 && (s = s.next(() => this.Xr(i))), n < 6 && r >= 6 && (s = s.next(() => (function __PRIVATE_createDocumentGlobalStore(e2) {
    ...
    }(e)).next(() => this.ii(e, i)).next(() => e.deleteObjectStore("remoteDocuments"))), n < 14 && r >= 14 && (s = s.next(() => this.si(e, i))), n < 15 && r >= 15 && (s = s.next(() => function __PRIVATE_createFieldIndex(e2) {
  ...
  si(e, t) {
    const n = t.store("mutations"), r = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), i = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.Hr, this.serializer.ct);
    return n.U().next((e2) => {
      const n2 = /* @__PURE__ */ new Map();
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 16) {
    ...
    this.Ii = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.D()) throw new FirestoreError(C.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
  ...
  Ai() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (this.isPrimary) return this.gi(e).next((e2) => {
  ...
  async Di() {
    if (this.isPrimary && !this.Ci(this.Pi, 18e5)) {
      ...
      const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (e2) => {
        ...
        return t.U().next((e3) => {
          const n = this.vi(e3, 18e5), r = e3.filter((e4) => -1 === n.indexOf(e4));
  ...
  pi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get("owner").next((t) => {
      if (null !== t && this.Ci(t.leaseTimestampMs, 5e3) && !this.Mi(t.ownerId)) {
        if (this.Si(t) && this.networkEnabled) return true;
        if (!this.Si(t)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).U().next((e2) => void 0 === this.vi(e2, 5e3).find((e3) => {
   ...
   */
  Bi() {
    return this.runTransaction("getActiveClients", "readonly", (e) => __PRIVATE_clientMetadataStore(e).U().next((e2) => this.vi(e2, 18e5).map((e3) => e3.clientId)));
  }
  get started() {
    return this.qr;
  }
  ...
  runTransaction(e, t, n) {
    ...
    const r = "readonly" === t ? "readonly" : "readwrite", i = (
      ...
      function __PRIVATE_getObjectStores(e2) {
        return 16 === e2 ? te : 15 === e2 ? ee : 14 === e2 ? X : 13 === e2 ? Z : 12 === e2 ? Y : 11 === e2 ? J : void fail();
      }(this.ui)
    );
    let s;
    return this.Ei.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.kr ? this.kr.next() : __PRIVATE_ListenSequence.oe), "readwrite-primary" === t ? this.gi(s).next((e2) => !!e2 || this.pi(s)).next((t2) => {
      if (!t2) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.oi.enqueueRetryable(() => this.Ii(false)), new FirestoreError(C.FAILED_PRECONDITION, F);
      return n(s);
  ...
  ki(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Ci(e2.leaseTimestampMs, 5e3) && !this.Mi(e2.ownerId) && !this.Si(e2) && !(this.ai || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(C.FAILED_PRECONDITION, Re);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.ji(e, t).next((e2) => {
      ...
      if (!i.result) return this.Hi(e, t, r, n).next((e2) => {
        i.result = e2;
      });
    }).next(() => {
      if (i.result) return;
      ...
      return this.Ji(e, t, n2).next((r2) => {
        if (i.result = r2, this.Ui) return this.Yi(e, t, n2, r2.size);
      });
    }).next(() => i.result);
  }
  Yi(e, t, n, r) {
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (e2) => {
    ...
    return (null === r || e2.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.ns = n.ns.insert(e2.targetId, e2), n.rs.set(t, e2.targetId)), e2;
  });
}
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      return void 0 !== i2 ? PersistencePromise.resolve(r2.ns.get(i2)) : r2.Qr.getTargetData(t2, n2);
...
function __PRIVATE_localStoreGetCachedTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r = __PRIVATE_debugCast(n.Qr), i = n.ns.get(t);
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  const n = __PRIVATE_debugCast(e), r = n.ss.get(t) || SnapshotVersion.min();
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
  ...
  for (const e2 of n) {
    ...
    const r2 = t.Is(e2);
    r2.setReadTime(t.Ts(e2.metadata.readTime)), o = o.insert(n2, r2);
  }
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0) return i.$r.saveNamedQuery(e2, t);
    const o = r.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
    return i.ns = i.ns.insert(o.targetId, o), i.Qr.updateTargetData(e2, o).next(() => i.Qr.removeMatchingKeysForTargetId(e2, r.targetId)).next(() => i.Qr.addMatchingKeys(e2, n, r.targetId)).next(() => i.$r.saveNamedQuery(e2, t));
  });
}
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    this.window = e, this.oi = t, this.persistenceKey = n, this.Vs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.fs = this.gs.bind(this), this.ps = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
  ...
  async start() {
    ...
    for (const e2 of this.ys) this.gs(e2);
          ...
          if (null !== t.key) {
            if (this.bs.test(t.key)) {
              ...
              }
              {
                ...
                if (e2) return this.Us(e2.clientId, e2);
              }
              ...
              await Promise.all(e2.map((e3) => this.syncEngine.Ys(e3)));
            }
          }
        } else this.ys.push(t);
      });
  ...
  Us(e, t) {
    const n = t ? this.ps.insert(e, t) : this.ps.remove(e), r = this.Ns(this.ps), i = this.Ns(n), s = [], o = [];
    return i.forEach((e2) => {
      r.has(e2) || s.push(e2);
    }), r.forEach((e2) => {
      i.has(e2) || o.push(e2);
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          h = true, P.po(new FirestoreError(n3, i3)), c.close();
        } else __PRIVATE_logDebug(fe, `RPC '${e}' stream ${r} received:`, i2), P.yo(i2);
      }
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r, i, s, o, _) {
    this.oi = e, this.Go = n, this.zo = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, /**
  ...
  async close(e, t) {
    ...
    this.jo++, 4 !== e ? (
      ...
      (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.Yo.Ko())
...
var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
  ...
  onMessage(e) {
    ...
    return __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length), this.T_ = true, this.listener.R_();
  }
  /**
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r, i) {
     ...
     */
    this.x_ = [], this.O_ = i, this.O_.io((e2) => {
...
async function __PRIVATE_enableNetworkInternal(e) {
  if (__PRIVATE_canUseNetwork(e)) for (const t of e.x_) await t(
    /* enabled= */
    true
  );
}
async function __PRIVATE_disableNetworkInternal(e) {
  for (const t of e.x_) await t(
    /* enabled= */
    false
  );
}
function __PRIVATE_remoteStoreListen(e, t) {
  ...
  ) : __PRIVATE_ensureWatchStream(n).Xo() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r = __PRIVATE_ensureWatchStream(n);
  n.F_.delete(t), r.Xo() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.F_.size && (r.Xo() ? r.n_() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
    ...
    */
    function __PRIVATE_raiseWatchSnapshot(e2, t3) {
      ...
      n2.targetMismatches.forEach((t4, n3) => {
        ...
        if (!r)
          return;
        e2.F_.set(t4, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).E_ && // This error affects the actual write.
  await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      ...
      const n = e2.v_.shift();
      __PRIVATE_ensureWriteStream(e2).t_(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  (e.B_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.B_.t_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.N_.set(
      "Unknown"
      /* OnlineState.Unknown */
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.k_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    t ? (e.k_.t_(), // This will start the write stream if necessary.
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.G_() ? 0 : 1);
  try {
    switch (r) {
      case 0:
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e2 of t) {
    ...
    if (i) {
      for (const t3 of i.U_) t3.H_(e2) && (r = true);
      i.K_ = e2;
    }
  }
...
function __PRIVATE_eventManagerOnWatchError(e, t, n) {
  ...
  if (i) for (const e2 of i.U_) e2.onError(n);
  r.queries.delete(t);
}
...
var __PRIVATE_View = class {
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l !== h && (n.track({
          ...
          type: 2,
          doc: c
        }), P = true, (_ && this.Ia(c, _) > 0 || a && this.Ia(c, a) < 0) && // This doc moved from inside the limit to outside the limit.
  ...
  applyChanges(e, t, n, r) {
    ...
    }(e2.type, t2.type) || this.Ia(e2.doc, t2.doc)), this.Va(n), r = null != r && r;
    const o = t && !r ? this.ma() : [], _ = 0 === this.Pa.size && this.current && !r ? 1 : 0, a = _ !== this.ha;
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Sa = {}, this.ba = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Da = /* @__PURE__ */ new Map(), /**
...
async function __PRIVATE_syncEngineListen(e, t, n = true) {
  ...
  return s ? (
    ...
    (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.ya())
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  ...
  const s = await __PRIVATE_localStoreExecuteQuery(
    ...
    /* usePreviousResults= */
    true
  ), o = new __PRIVATE_View(t, s.hs), _ = o.da(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = o.applyChanges(
    _,
    /* limboResolutionEnabled= */
    e.isPrimaryClient,
    a
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1) return r.Da.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.ba.delete(t);
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      ...
      (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r.wa = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.wa) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.wa), r.wa = false));
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.Ma.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
    ...
    e.Ma.containsKey(r.key) || // We removed the last reference for this key
...
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  ...
  r.ba.isEmpty() || (r.ba.forEach((e2, _) => {
    o.push(r.Ba(_, t, n).then((e3) => {
      ...
      if (e3) {
        i.push(e3);
        const t3 = __PRIVATE_LocalViewChanges.Ki(_.targetId, e3);
        s.push(t3);
      }
    }));
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  const i = __PRIVATE_debugCast(e), s = await function __PRIVATE_localStoreLookupMutationDocuments(e2, t2) {
    ...
    return n2.persistence.runTransaction("Lookup mutation documents", "readonly", (e3) => r2.vn(e3, t2).next((t3) => t3 ? n2.localDocuments.getDocuments(e3, t3) : PersistencePromise.resolve(null)));
  }(i.localStore, t);
  null !== s ? ("pending" === n ? (
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  ...
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.La) {
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.Ma.mr(), t3.Fa = /* @__PURE__ */ new Map(), t3.va = new SortedMap(DocumentKey.comparator);
...
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    let t2;
    const n2 = r.Da.get(e2);
    if (n2 && 0 !== n2.length) {
      t2 = await __PRIVATE_localStoreAllocateTarget(r.localStore, __PRIVATE_queryToTarget(n2[0]));
      for (const e3 of n2) {
        const t3 = r.ba.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.La) {
    for (const e2 of t) {
      if (r.Da.has(e2) && r.sharedClientState.isActiveQueryTarget(e2)) {
    ...
    for (const e2 of n)
      r.Da.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        /* keepPersistedTargetData */
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      if (await function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("hasNewerBundle", "readonly", (e4) => n3.$r.getBundleMetadata(e4, t3.id)).then((e4) => !!e4 && e4.createTime.compareTo(r3) >= 0);
      ...
      }(e2.localStore, r2), n2._completeWith(o.progress), Promise.resolve(o.ua);
    } catch (e3) {
...
var __PRIVATE_LruGcMemoryOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  createPersistence(e) {
    ...
    return new __PRIVATE_MemoryPersistence((e2) => __PRIVATE_MemoryLruDelegate.Hr(e2, t), this.serializer);
  }
};
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  async initialize(e) {
    ...
    // set it after localStore / remoteStore are started.
    await this.persistence.fi(async (e2) => {
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    ...
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, i = await n.xo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
      i.forEach((e3) => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.Za = n.maxAttempts, this.Yo = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r.hs), s = i.da(r.documents), o = i.applyChanges(
        s,
        /* limboResolutionEnabled= */
        false
      );
  ...
  return e.asyncQueue.enqueueAndForget(async () => {
    try {
      ...
      r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e2, t2, n2) {
        ...
        i2.connection.Do || delete s.parent;
        const a = (await i2.xo(
          "RunAggregationQuery",
...
function __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(e, t) {
  return e.asyncQueue.enqueue(async () => function __PRIVATE_localStoreSetIndexAutoCreationEnabled(e2, t2) {
    __PRIVATE_debugCast(e2).ts.Ui = t2;
  }(await __PRIVATE_getLocalStore(e), t));
}
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.fu) throw 1 === e.fu ? e.Du(`${this._methodName}() can only appear at the top level of your update data`) : e.Du(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Mu.map((e2) => __PRIVATE_parseData(e2, t)), r = new __PRIVATE_ArrayUnionTransformOperation(n);
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Mu.map((e2) => __PRIVATE_parseData(e2, t)), r = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
...
function __PRIVATE_parseQueryValue(e, t, n, r = false) {
  return __PRIVATE_parseData(n, e.Fu(r ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.fu)) throw t2.Du(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path) throw t2.Du(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n)) throw t2.Du(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
...
function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
  if (t.search(be) >= 0) throw __PRIVATE_createError(
...
function runTransaction(e, t, n) {
  ...
  return function __PRIVATE_firestoreClientTransaction(e2, t2, n2) {
    ...
    return e2.asyncQueue.enqueueAndForget(async () => {
      ...
      new __PRIVATE_TransactionRunner(e2.asyncQueue, i, n2, t2, r2).Xa();
    }), r2.promise;
